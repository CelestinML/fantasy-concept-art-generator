...
class MachineLearningClassifier(PrepaData) :
    ...
    def __init__(self, epochs, nb_train_samples, nb_validation_samples, class_mode, save = None, X=None, y=None, batch_size = None, img_shape = None, train_dir = None, test_dir = None, val_dir = None) :
