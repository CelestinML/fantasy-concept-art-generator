...
gan = MachineLearningClassifier(save="pokemons3.h5", epochs=101, nb_train_samples=5212, nb_validation_samples=17,
...
gan.gan_suite(batch_size=50, noise_shape=100, save = "pokemons3")
gan.save_generator()